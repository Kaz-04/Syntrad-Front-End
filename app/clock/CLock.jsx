...
import { ArrowLeft, ShieldCheck, Wrench, Clock as ClockIcon } from "lucide-react";
...
const clockImages = [
  "/assets/overhaul.webp",
  "/assets/pendulum.webp",
  "/assets/chime.jpg",
  "/assets/restoration.jpg",
  "/assets/weight.jpg",
  "/assets/home.webp",
];
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-28 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h1 className="text-5xl lg:text-6xl font-extrabold leading-tight">
              Grandfather & Antique
              <span className="block text-red-600">Clock Repair</span>
            </h1>

            <p className="mt-6 text-lg text-gray-300 max-w-xl">
              Precision restoration for traditional pendulum and weight-driven
              clocks. Preserving heritage, craftsmanship, and timekeeping
              accuracy.
            </p>
            ...
            <div className="flex gap-6 mt-8 text-gray-300 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <ClockIcon className="text-red-500" /> Decades of Expertise
              </div>
              <div className="flex items-center gap-2">
                <Wrench className="text-red-500" /> Workshop & On-site
              </div>
            </div>
          ...
          {[
            {
              ...
              desc: "Trusted care for antique, vintage & heirloom clocks.",
            },
            {
              title: "On-site Servicing",
              desc: "Home, museum & heritage property visits available.",
            },
            {
              title: "Full Restoration",
              desc: "Cleaning, calibration, woodwork & mechanical overhaul.",
            },
          ].map((item, i) => (
            <div
              key={i}
      ...
      {showRequestQuote && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
          <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl">
            <RequestQuote
              isModal
              initialService="Clock Repair Service"
