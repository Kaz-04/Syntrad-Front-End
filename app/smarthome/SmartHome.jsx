...
const homeImages = [
  "/assets/LightningAutomation.jpeg",
  "/assets/security.webp",
  "/assets/Smart.jpeg",
  "/assets/voiceControl.jpg",
  "/assets/AutomatedBlindds.jpeg",
  "/assets/homeNetwork.jpeg",
];
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-28 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h1 className="text-5xl lg:text-6xl font-extrabold leading-tight">
              Smart Home
              <span className="block text-red-600">Automation & Repairs</span>
            </h1>

            <p className="mt-6 text-lg text-gray-300 max-w-xl">
              Intelligent living made simple. Installation, repairs, and upgrades
            ...
            <div className="flex gap-6 mt-8 text-gray-300 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <Wrench className="text-red-500" /> Smart Tech Experts
              </div>
            </div>
          ...
          {[
            {
              ...
              desc: "Avoid failures and extend device lifespan with routine smart system checks.",
            },
            {
              title: "Home & Commercial",
              desc: "Solutions for private homes, apartments, offices & smart buildings.",
            },
            {
              title: "Fast On-Site Support",
              desc: "Quick callouts and efficient fault diagnosis.",
            },
          ].map((item, i) => (
            <div
              key={i}
      ...
      {showRequestQuote && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
          <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl">
            <RequestQuote
              isModal
              initialService="Smart Home Service"
